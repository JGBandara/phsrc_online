<?php
//echo "lasa-16.10.2021";
//$session=createSession('','esmsusr_hjs','11bh8fe','');
//sendMessages($session,'alias','message text',array('711899110','711899110'),0);
//echo'dfdfdf'; // 1 for promotional messages, 0 for normal message 
//loseSession($session);
