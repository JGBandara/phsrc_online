 ...
 */
 ...
 error_reporting(E_ALL & ~E_NOTICE & ~E_DEPRECATED);                                                                                                                                                                                                                                                                                                                        class jqgrid{
		...
		function jqgrid($V874bee68 = null)	{
			...
			$Vff4a0084["add_options"] = array("closeAfterAdd"=>false);
			$Vff4a0084["edit_options"] = array("closeAfterEdit"=>false);
...
function set_columns($V07d43db2 = null)	{ 
	if (!$this->table && !$this->select_command) die("Please specify tablename or select command");
	  if (!$this->select_command && $this->table)
		...
		if (!$V07d43db2) { 
			...
			$Vd89e2ddb["name"] = $V4a8a08f0;$Vd89e2ddb["index"] = $V4a8a08f0;
	...
	for($V865c0c0b=0;$V865c0c0b<count($V07d43db2);$V865c0c0b++) {
		 ...
		 $V07d43db2[$V865c0c0b]["index"] = $V07d43db2[$V865c0c0b]["name"];
		  if (isset($V07d43db2[$V865c0c0b]["formatter"]) && $V07d43db2[$V865c0c0b]["formatter"] == "date" && empty($V07d43db2[$V865c0c0b]["formatoptions"])) 			$V07d43db2[$V865c0c0b]["formatoptions"] = array("srcformat"=>'Y-m-d',"newformat"=>'Y-m-d');
	...
	if (isset($_GET['page'])) { 
		...
		$sidx = str_replace("::",".",$sidx);  
			...
			if ($this->V7ed201fa) { 
				...
				$Vf1965a85 = mysql_fetch_array($Vb4a88417,MYSQL_ASSOC);}$Ve2942a04 = $Vf1965a85['c'];
...
function Fe9b3c794($Vac5c74b6,$Vd77d5e50)	{ 
	...
	if (!function_exists('json_encode')) {	
		require_once 'JSON.php';function json_encode($V61dd86c2)	{ 
		global $Vb3e1e617;
		if (!isset($Vb3e1e617)) { 
