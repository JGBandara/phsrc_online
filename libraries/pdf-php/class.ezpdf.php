...
// ------------------------------------------------------------------------------
function rbTable(&$data,$title='',$options=''){
	
	$this->ezTable(&$data,'',$title='',$options='');
}
...
// note that the user will have had to make a font selection already or this will not // produce a valid pdf file.
	...
	$defaults = array( 'shaded'=>1,'showBgCol'=>0,'showLines'=>1,'shadeCol'=>array(0.8,0.8,0.8),'shadeCol2'=>array(0.7,0.7,0.7),'fontSize'=>7,'titleFontSize'=>13
	,'titleGap'=>6,'lineCol'=>array(0,0,0),'gap'=>5,'xPos'=>'centre','xOrientation'=>'centre'
