...
$configArray["gatewayUrl"] = "https://test-bankofceylon.mtf.gateway.mastercard.com/api/nvp";


// Merchant ID supplied by your payments provider
$configArray["merchantId"] = "700193990043";

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "Merchant.700193990043";

// API password which can be configured in Merchant Administration
$configArray["password"] = "1d82b5a9bb3365ebd4b88452ecaabdab";
