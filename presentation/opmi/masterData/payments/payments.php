...
$_SESSION['institute_id']=$searchId;
                      ...
                      <tr>
                        <th style="background-color:#FFF;color:#006400"><label id="msgPayment"></label></th>
                         ...
                         <div class="form-row">
                          ...
                          <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control form-control-sm" id="txtYear" name="txtYear" placeholder="" value="2019">
                          </div>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control form-control-sm" id="txtRegFee" name="txtRegFee" placeholder="" value="0" style="text-align:right;color:green" readonly >
                          </div>
                          <div class="form-group col-sm-6">
                         ...
                         <div class="form-row">
                          <div class="form-group col-sm-6">
                            <label for="txtArrears" class="col-form-label-sm">Main Board Price (LKR)</label>
                          ...
                          <div class="form-group col-sm-6">
                            ...
                            <input type="number" class="form-control form-control-sm" id="txtAmount" name="txtAmount" placeholder="" style="text-align:right;color:green" value="0"  readonly>
                          </div>
                        </div>
...
?>
                          ...
                          <div class="form-group col-sm-6">
                            ...
                            <input type="date" class="form-control form-control-sm datepicker_past" id="txtPaymentDate" name="txtPaymentDate" placeholder="">
                          </div>
                        </div>
     ...
     <img src="../../../../img/bankSlip.jpg" >
                ...
                <div class="card-footer">
                  ...
                  <div class="col-sm-12 text-center">
                     ...
                     <button type="button" class="btn btn-success" id="btnResubmit" style="width: 150px; margin: 5px;"><i class="far fa-save"></i>&nbsp;Re-Submit</button>
