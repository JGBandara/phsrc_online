...
$( document ).ready( function () {
  ...
  //      Close Function
  // --------------------------------------------------------
  $("#frmhrm_employee_files #btnDocument").click(function(){  
    window.location.assign("../Payments/payments.php?id="+instituteId);
  });
  // ---------------------------------------------------------
  // --------------------------------------------------------
  //      Save Function
...
//              $('.status', $newRow).html(json[i].stat_name);
  ...
  // ---------------------------------
  loadSearchCombo(instituteId);

});// Document Ready End

function loadSearchCombo(instituteId){
	var url = "misInformation-db-get.php?requestType=loadSearchCombo&id="+instituteId;
	var httpobj = $.ajax({url:url,async:false})
	$('#frmhrm_employee_files #cboSearch').html(httpobj.responseText);
	$('#frmhrm_employee_files #cboSearch').val(instituteId);
	$('#frmhrm_employee_files #cboSearch').trigger('change');
}
