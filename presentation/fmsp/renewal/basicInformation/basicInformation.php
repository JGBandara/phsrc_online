              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" name="txtSearch" id="txtSearch" value="PHSRC/FMS/">
                      ...
                      <div class="col-sm-8">
                        <div class="form-row">
                          <div class="form-group col-sm-12">
                            <label for="txtName" class="col-form-label-sm">Want to get verified before renewal</label>
...
<!--                                  <input class="form-check-input" type="radio" name="optConfirmStatus" id="optConfirmStatus_2" value="0">
                                  ...
                                  <button type="button" class="btn btn-success" id="btnSendCode" style="width: 100px; margin: 5px;"><i class="far fa-save"></i>&nbsp;Send</button>
                                </div>
                              </div>
                          </div>
                        </fieldset>
