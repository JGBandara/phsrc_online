  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-auto">
                    <div class="text-lg text-left font-weight-bold text-heder-text mb-1">Full Time Medical Specialist Practices</div>
                  </div>
                  <div class="col-auto">
                  <center><img class="rounded-circle border-red border-2" style="border:5px solid black;width:100px;height:100px" src="../../img/core/full_time_medi_specialist.jpg" alt="" /></center>
        ...
        <!-- /.container-fluid -->
<iframe src="../../Document/Full_time_Medical_Specialists.pdf" frameborder="0" height="350px" width="100%"></iframe>
      </div>
      <!-- End of Main Content -->
