...
if($requestType=='loadDetails'){
  ...
  Inner Join man_institute_main ON institute_registration.ins_type_id = man_institute_main.main_cat_id  where is_renew=0 and institute_payment_detail.paymet_is_success=1 and institute_registration.ins_type_id=10 and institute_registration.ins_created_by=$userId order by ins_application_id asc";
