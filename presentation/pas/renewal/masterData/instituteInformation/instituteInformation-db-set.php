...
$cboCompanyType           = isset($_REQUEST['cboCompanyType'])?trim($_REQUEST['cboCompanyType']):null;
    ...
    if($row = mysqli_fetch_row($result)){
      ...
      $sql="update `institute_information`
            set
					...
					ins_company_type					='$cboCompanyType'
      ...
      $sql="insert into `institute_information`
            ( ins_info_institute_id,ins_date_of_stablishment,ins_br_no,ins_boi_registration,ins_company_type, ins_info_company_id, ins_info_created_by, ins_info_created_on)
              values              ('$id','$txtEstDate','$txtBR','$txtBOI','$cboCompanyType','$companyId', '$createdBy', '". time()."')";
