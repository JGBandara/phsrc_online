  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-auto">
                    <div class="text-lg text-left font-weight-bold text-heder-text mb-1">Private Ambulance Services</div>
                  </div>
                  <div class="col-auto">
                  <center><img class="rounded-circle border-red border-2" style="border:5px solid black;width:100px;height:100px" src="../../img/core/Ambulance.png" alt="" /></center>
        ...
        <!-- /.container-fluid -->
<iframe src="../../Document/General_Information_of_Ambulance_Services.pdf" frameborder="0" height="350px" width="100%"></iframe>
      </div>
      <!-- End of Main Content -->
...
<button class="open-button" onclick="openForm()">For More Details</button>
 ...
 <div class="form-popup" id="myForm">
  <form action="" class="form-container">
      ...
      <label><b>Mr. Tasith Jayarathne </b></label><br/>
