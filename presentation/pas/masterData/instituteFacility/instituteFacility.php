...
<html>
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <!-- Sidebar -->
      <?php include "{$backwardSeparator}presentation/pas/menu.php";?>      <!-- End of Sidebar -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                          <div class="form-group col-sm-4">
                            <label for="lblOfficeAddr" class="col-form-label-sm">No of Ambulances</label>
                            <input type="number" class="form-control form-control-sm" id="txtNoAmbulance" name="txtNoAmbulance" placeholder="">
                          </div>
                          <div class="form-group col-sm-4">
                            <label for="txtAddress" class="col-form-label-sm">Model</label>
                            <input type="text" class="form-control form-control-sm" id="txtModal" name="txtModal" placeholder="">
                          </div>
                          <div class="form-group col-sm-4">
                            <label for="txtAddress" class="col-form-label-sm">Health staff to accompany patients</label>
                            <input type="text" class="form-control form-control-sm" id="txtHealthStaff" name="txtHealthStaff" placeholder="">
                          </div>
                        </div>                 
      ...
      <td><input type="text" class="form-control form-control-sm txtDiscription" id="txtDiscription" name="txtDiscription" placeholder=""></td>
                      ...
                      <div class="form-row">
                          ...
                          <div class="form-group col-sm-6">
                            <label for="txtLicense" class="col-form-label-sm">Extracts of the RMV Registration</label>
                            <input type="text" class="form-control form-control-sm" id="txtRMVreg" name="txtRMVreg" placeholder="">
                          </div>
                        </div>
