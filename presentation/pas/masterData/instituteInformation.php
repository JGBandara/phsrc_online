                   ...
                   <div id="divInstitute">
                    <div class="form-row">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-sm-6">
                            <label for="cboCompanyType" class="col-form-label-sm">Whether a public company or not</label>
                           <select class="form-control form-control-sm" id="cboCompanyType" name="cboCompanyType">
                           <option></option>
