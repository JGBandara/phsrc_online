  ...
  try{
    ...
    if($row = mysqli_fetch_row($result)){
      ...
      $sql="insert into `institute_facility`
            ( ins_faci_institute_id,ins_no_of_bed,ins_no_of_room,ins_no_of_ward, ins_info_company_id, ins_info_created_by, ins_info_created_on)
              values              ('$id','$txtNoBed','$txtNoRoom','$txtNoWard','1', '1', '". time()."')";
