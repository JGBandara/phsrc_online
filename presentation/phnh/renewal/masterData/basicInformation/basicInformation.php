                ...
                <div class="card-body">
                 ...
                 <div id="personal">
                      ...
                      <div class="col-sm-8">
                        <div class="form-row">
                          <div class="form-group col-sm-12">
                            <label for="txtName" class="col-form-label-sm required">Name of the person who is operating or maintaining the institution </label>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            <label for="lblOfficeAddr" class="col-form-label-sm required">Address(Official)</label>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            <label for="txtRelIns" class="col-form-label-sm required">The relationship with the institution </label>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            <label for="txtInsName" class="col-form-label-sm required">Name of the institution </label>
                            <input type="text" class="form-control form-control-sm" id="txtInsName" name="txtInsName" placeholder="">
                          </div>
                          <div class="form-group col-sm-6">
                            <label for="txtInsAddress" class=" col-form-label-sm required">Institute Address </label>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                            <label for="forMobile" class="col-form-label-sm required">Mobile Number</label>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                            <label for="txtEmail" class=" col-form-label-sm required">E-mail</label>
                            <!--<input type="text" class="form-control form-control-sm" id="txtFingerPrintNo" name="txtFingerPrintNo" placeholder="">--><input type="email" class="form-control form-control-sm" id="txtEmail" name="txtEmail" placeholder="eg -: xxxxxx@gmail.com">
                          </div>
                    ...
                    <legend class="col-form-label-sm col-sm-12 pt-0">Location of the institution</legend>
                      <div class="form-group col-sm-6">
                        <label for="cboProvince" class="col-form-label-sm required">Province<?php 
						//api();
						//function api(){
                      ...
                      <!--  <?php 
						 for($i=0;$i<$length;$i++){
							 ...
							 echo '<option value="'.$data['detailVal1'][$i]['pro_id'].'">'.$data['detailVal1'][$i]['pro_name'].'</option>';
							 }
						 ?> -->
                      ...
                      <div class="form-group col-sm-6">
                        <label for="cboDistrict" class="col-form-label-sm required">District</label>
