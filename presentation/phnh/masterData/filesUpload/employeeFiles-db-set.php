...
require_once $backwardSeparator.'dataAccess/connectionSt';
...
$branchId           = isset($_REQUEST['cboBranchId'])?trim($_REQUEST['cboBranchId']):null;
$accountType           = isset($_REQUEST['optAccountType'])?trim($_REQUEST['optAccountType']):null;
$accountNo           = isset($_REQUEST['txtAccountNo'])?trim($_REQUEST['txtAccountNo']):null;
$accountHolder           = isset($_REQUEST['txtAccountHolder'])?trim($_REQUEST['txtAccountHolder']):null;
$amount           = isset($_REQUEST['txtAmount'])?trim($_REQUEST['txtAmount']):null;
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `hrm_employee_bank_account`
          set
            ema_employee_id='$employeeId',
            ema_bank_id='$bankId',
            ema_branch_id='$branchId',
            ema_account_type='$accountType',
            ema_account_no='$accountNo',
            ema_account_holder='$accountHolder',
            ema_amount='$amount',
            ema_remarks='$remarks',
            ema_status='$status',
            ema_company_id='$companyId',
            ema_last_modified_by='$lastModifiedBy',
            ema_last_modified_on='". time()."'
          where ema_id='$id' and ema_company_id='$userCompanyId'";
