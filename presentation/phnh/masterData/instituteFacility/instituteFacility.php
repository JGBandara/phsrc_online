                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                          <div class="form-group col-sm-4">
                            <label for="lblOfficeAddr" class="col-form-label-sm required">Total no: of inpatient beds</label>
                            <input type="number" class="form-control form-control-sm" id="txtNoBed" name="txtNoBed" placeholder="">
                          </div>
                          <div class="form-group col-sm-4">
                            <label for="txtAddress" class="col-form-label-sm">Total No. of rooms</label>
                            <input type="number" class="form-control form-control-sm" id="txtNoRoom" name="txtNoRoom" placeholder="">
                          </div>
                          <div class="form-group col-sm-4">
                            <label for="txtAddress" class="col-form-label-sm">Total No. of Wards</label>
                            <input type="number" class="form-control form-control-sm" id="txtNoWard" name="txtNoWard" placeholder="">
                          </div>
                        </div>                 
...
&nbsp;Add Raw</button>--><img src="../../../../img/butAddNew.JPG" onClick="insertRow('tblMainGrid1');" style="width: 120px;float:right" class="mouseover"/>
    ...
    <tr style="background-color:#9CF">
      <th scope="col">#</th>
      <th scope="col" class="required">Facility</th>
    ...
    <tr class="mainRow" id="tblMainGrid1id1">
      ...
      <td><input type="number" class="form-control form-control-sm txtValue" id="txtValue" name="txtValue"  placeholder=""></td>
