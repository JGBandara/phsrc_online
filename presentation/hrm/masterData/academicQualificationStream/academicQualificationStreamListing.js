...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_academic_qualification_streamToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_academic_qualification_stream tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_academic_qualification_stream').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./academicQualificationStreamListing-db-get.php",
  ...
  $('#gridhrm_academic_qualification_stream').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_academic_qualification_streamListing #btnClose").click(function(){  
