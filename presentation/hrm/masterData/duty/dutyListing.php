...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./dutyListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_dutyListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_duty" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['dty_name'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_status'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_location_id'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['dty_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="dutyListing.js"></script>    
  </body>
</html>
