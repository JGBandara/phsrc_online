...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_duty tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_duty').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./dutyListing-db-get.php",
  ...
  $('#gridhrm_duty').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_dutyListing #btnClose").click(function(){  
