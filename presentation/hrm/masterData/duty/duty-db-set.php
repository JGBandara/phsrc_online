...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Du");
    }
    elseif($amStatus == "Manual"){
      $noReference	= $no;
    }
        //Add data to transaction header*******************************************
    $sql="insert into `hrm_duty`
            (dty_name, dty_remarks, dty_status, dty_location_id, dty_company_id, dty_created_by, dty_created_on)
              values 
                ('$name', '$remarks', '$status', '$locationId', '$companyId', '$createdBy', '". time()."')";
  ...
  try{
    ...
    $sql="update `hrm_duty`
          set
            ...
            dty_remarks='$remarks',
            dty_status='$status',
            dty_location_id='$locationId',
            dty_company_id='$companyId',
            dty_last_modified_by='$lastModifiedBy',
            dty_last_modified_on='". time()."'
          where dty_id='$id' and dty_company_id='$userCompanyId'  and dty_location_id='$userLocationId'";
