...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./employeeInformationListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_employee_informationListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_employee_information" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="employeeInformationListing.js"></script>    
  </body>
</html>
