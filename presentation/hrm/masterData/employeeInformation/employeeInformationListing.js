...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_employee_informationToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_employee_information tfoot th').each( function ($k) {
      if($k!=0){
        var title = $(this).text();
  ...
  // Create Table
  // ---------------------------------
  var table = $('#gridhrm_employee_information').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./employeeInformationListing-db-get.php",
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_employee_informationListing #btnClose").click(function(){  
