      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_service_category">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sct_name'];?></label>
                    ...
                    <div class="form-row">
                      <label for="txtCode" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sct_code'];?></label>
                      <div class="form-group col-sm-10">
                    ...
                    <div class="form-row">
                      <label for="txtRemarks" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sct_remarks'];?></label>
                      <div class="form-group col-sm-10">
                    ...
                    <div class="form-row">
                      <label for="cboStatus" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sct_status'];?></label>
                      <div class="form-group col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?>    
    ...
    <script src="serviceCategory.js"></script>  </body>
</html>
