...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./serviceCategoryListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_service_categoryListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_service_category" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['sct_name'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_code'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_status'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sct_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="serviceCategoryListing.js"></script>    
  </body>
</html>
