      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_academic_qualification_subject">
              <div class="card">
                <div class="card-header">
                   Academic Qualification Subject
                </div>
                <div class="card-body">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                      <label for="cboQualificationTypeId" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['aqb_qualification_type_id'];?></label>
                      <div class="form-group col-sm-10">
                        <select class="form-control form-control-sm" id="cboQualificationTypeId" name="cboQualificationTypeId" placeholder="">
                          <?php 
                          $modelQualificationType = new cls_hrm_academic_qualification_type($db);
                          $modelQualificationType->aqt_status = 1;
                          $modelQualificationType->aqt_is_deleted = 0;
                          $modelQualificationType->aqt_company_id = $userCompanyId;
                          echo $modelQualificationType->combo(true);
                          ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['aqb_name'];?></label>
                      <div class="form-group col-sm-10">
                    ...
                    <div class="form-row">
                      <label for="txtRemarks" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['aqb_remarks'];?></label>
                      <div class="form-group col-sm-10">
                    ...
                    <div class="form-row">
                      <label for="cboStatus" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['aqb_status'];?></label>
                      <div class="form-group col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?>    
    ...
    <script src="academicQualificationSubject.js"></script>  </body>
</html>
