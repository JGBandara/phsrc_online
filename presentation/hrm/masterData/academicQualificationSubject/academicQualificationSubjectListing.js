...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_academic_qualification_subjectToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_academic_qualification_subject tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_academic_qualification_subject').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./academicQualificationSubjectListing-db-get.php",
  ...
  $('#gridhrm_academic_qualification_subject').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_academic_qualification_subjectListing #btnClose").click(function(){  
