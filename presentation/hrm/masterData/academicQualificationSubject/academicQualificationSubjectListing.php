...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./academicQualificationSubjectListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_academic_qualification_subjectListing">
              <div class="card">
                <div class="card-header">
                   Academic Qualification Subject Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_academic_qualification_subject" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['aqb_qualification_type_id'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_name'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_status'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['aqb_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="academicQualificationSubjectListing.js"></script>    
  </body>
</html>
