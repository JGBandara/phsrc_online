...
$response = [];
$autoNoType = "academicQualificationSubject";   
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Ac");
    ...
    $sql="insert into `hrm_academic_qualification_subject`
            (aqb_qualification_type_id, aqb_name, aqb_remarks, aqb_status, aqb_company_id, aqb_created_by, aqb_created_on)
              values 
                ('$qualificationTypeId', '$name', '$remarks', '$status', '$companyId', '$createdBy', '". time()."')";
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `hrm_academic_qualification_subject`
          set
            aqb_qualification_type_id='$qualificationTypeId',
            aqb_name='$name',
            aqb_remarks='$remarks',
            aqb_status='$status',
            aqb_company_id='$companyId',
            aqb_last_modified_by='$lastModifiedBy',
            aqb_last_modified_on='". time()."'
          where aqb_id='$id' and aqb_company_id='$userCompanyId' ";
