...
$response = [];
$autoNoType = "otherQualificationCategory";   
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Ot");
    ...
    $sql="insert into `hrm_other_qualification_category`
            (oqc_name, oqc_remarks, oqc_status, oqc_company_id, oqc_created_by, oqc_created_on)
              values 
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `hrm_other_qualification_category`
          set
            oqc_name='$name',
            oqc_remarks='$remarks',
            oqc_status='$status',
            oqc_company_id='$companyId',
            oqc_last_modified_by='$lastModifiedBy',
            oqc_last_modified_on='". time()."'
          where oqc_id='$id' and oqc_company_id='$userCompanyId' ";
