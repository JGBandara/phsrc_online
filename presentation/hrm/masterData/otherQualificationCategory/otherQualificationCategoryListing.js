...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_other_qualification_categoryToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_other_qualification_category tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_other_qualification_category').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./otherQualificationCategoryListing-db-get.php",
  ...
  $('#gridhrm_other_qualification_category').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_other_qualification_categoryListing #btnClose").click(function(){  
