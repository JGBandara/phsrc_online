...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./divisionListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_divisionListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_division" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['div_name'];?></th>
                                <th><?php echo $model->attributeLabels()['div_code'];?></th>
                                <th><?php echo $model->attributeLabels()['div_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['div_status'];?></th>
                                <th><?php echo $model->attributeLabels()['div_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['div_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['div_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['div_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['div_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['div_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['div_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['div_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="divisionListing.js"></script>    
  </body>
</html>
