...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Di");
    }
    elseif($amStatus == "Manual"){
      $noReference	= $no;
    }
        //Add data to transaction header*******************************************
    $sql="insert into `hrm_division`
            (div_name, div_code, div_remarks, div_status, div_company_id, div_created_by, div_created_on)
              values 
                ('$name', '$code', '$remarks', '$status', '$companyId', '$createdBy', '". time()."')";
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `hrm_division`
          set
            div_name='$name',
            div_code='$code',
            div_remarks='$remarks',
            div_status='$status',
            div_company_id='$companyId',
            div_last_modified_by='$lastModifiedBy',
            div_last_modified_on='". time()."'
          where div_id='$id' and div_company_id='$userCompanyId'";
