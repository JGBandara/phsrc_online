...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./academicQualificationTypeListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_academic_qualification_typeListing">
              <div class="card">
                <div class="card-header">
                   Academic Qualification Type Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_academic_qualification_type" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['aqt_name'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_status'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['aqt_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="academicQualificationTypeListing.js"></script>    
  </body>
</html>
