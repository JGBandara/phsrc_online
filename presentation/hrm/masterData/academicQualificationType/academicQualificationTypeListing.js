...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_academic_qualification_typeToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_academic_qualification_type tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_academic_qualification_type').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./academicQualificationTypeListing-db-get.php",
  ...
  $('#gridhrm_academic_qualification_type').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_academic_qualification_typeListing #btnClose").click(function(){  
