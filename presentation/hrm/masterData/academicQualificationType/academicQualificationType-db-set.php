...
$response = [];
$autoNoType = "academicQualificationType";   
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Ac");
    ...
    $sql="insert into `hrm_academic_qualification_type`
            (aqt_name, aqt_remarks, aqt_status, aqt_company_id, aqt_created_by, aqt_created_on)
              values 
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `hrm_academic_qualification_type`
          set
            aqt_name='$name',
            aqt_remarks='$remarks',
            aqt_status='$status',
            aqt_company_id='$companyId',
            aqt_last_modified_by='$lastModifiedBy',
            aqt_last_modified_on='". time()."'
          where aqt_id='$id' and aqt_company_id='$userCompanyId' ";
