...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_employee_bank_accountToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_employee_bank_account tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // Create Table
  // ---------------------------------
  var table = $('#gridhrm_employee_bank_account').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./employeeBankAccountListing-db-get.php",
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_employee_bank_accountListing #btnClose").click(function(){  
