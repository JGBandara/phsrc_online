...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./salaryScaleListingToggle.php";?>
        <!-- Partial View Modal -->
            ...
            <form class="needs-validation" novalidate id="frmhrm_salary_scaleListing">
              <div class="card">
                <div class="card-header">
                   Salary Scale Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_salary_scale" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['scl_code'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_name'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_status'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['scl_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="salaryScaleListing.js"></script>    
  </body>
</html>
