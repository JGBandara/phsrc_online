...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_employee_emergencyToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_employee_emergency tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // Create Table
  // ---------------------------------
  var table = $('#gridhrm_employee_emergency').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./employeeEmergencyListing-db-get.php",
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_employee_emergencyListing #btnClose").click(function(){  
