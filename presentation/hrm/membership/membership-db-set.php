...
$dateOfCommencement           = isset($_REQUEST['dtpDateOfCommencement'])?trim($_REQUEST['dtpDateOfCommencement']):null;
$renewalDate           = isset($_REQUEST['dtpRenewalDate'])?trim($_REQUEST['dtpRenewalDate']):null;
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Me");
    ...
    $sql="insert into `hrm_trn_membership`
            (mem_employee_id, mem_name, mem_type, mem_category, mem_date_of_commencement, mem_renewal_date, mem_remarks, mem_status, mem_company_id, mem_created_by, mem_created_on)
              values 
                ('$employeeId', '$name', '$type', '$category', '$dateOfCommencement', '$renewalDate', '$remarks', '$status', '$companyId', '$createdBy', '". time()."')";
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `hrm_trn_membership`
          set
            mem_employee_id='$employeeId',
            mem_name='$name',
            mem_type='$type',
            mem_category='$category',
            mem_date_of_commencement='$dateOfCommencement',
            mem_renewal_date='$renewalDate',
            mem_remarks='$remarks',
            mem_status='$status',
            mem_company_id='$companyId',
            mem_last_modified_by='$lastModifiedBy',
            mem_last_modified_on='". time()."'
          where mem_id='$id' and mem_company_id='$userCompanyId' ";
