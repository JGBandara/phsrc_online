      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_trn_membership">
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                      <div class="form-group col-sm-4">
                        <label for="cboEmployeeId" class="col-form-label-sm"><?php echo $model->attributeLabels()['mem_employee_id'];?></label>
                      ...
                      <div class="form-group col-sm-4">
                        <label for="txtName" class="col-form-label-sm"><?php echo $model->attributeLabels()['mem_name'];?></label>
                        <input type="text" class="form-control form-control-sm" id="txtName" name="txtName" placeholder="">
                      </div>
                      <div class="form-group col-sm-4">
                        <label for="txtType" class="col-form-label-sm"><?php echo $model->attributeLabels()['mem_type'];?></label>
                    ...
                    <div class="form-row">
                      <div class="form-group col-sm-4">
                        <label for="txtCategory" class="col-form-label-sm"><?php echo $model->attributeLabels()['mem_category'];?></label>
                        <input type="text" class="form-control form-control-sm" id="txtCategory" name="txtCategory" placeholder="">
                      </div>
                      <div class="form-group col-sm-4">
                        <label for="dtpDateOfCommencement" class="col-form-label-sm"><?php echo $model->attributeLabels()['mem_date_of_commencement'];?></label>
                        <input type="text" class="form-control form-control-sm datepicker_past" id="dtpDateOfCommencement" name="dtpDateOfCommencement" placeholder="">
                      </div>
                      <div class="form-group col-sm-4">
                        <label for="dtpRenewalDate" class="col-form-label-sm"><?php echo $model->attributeLabels()['mem_renewal_date'];?></label>
                        <input type="text" class="form-control form-control-sm datepicker_any" id="dtpRenewalDate" name="dtpRenewalDate" placeholder="">
                      </div>
                    </div>
        
                    <div class="form-row">
                      <label for="txtRemarks" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['mem_remarks'];?></label>
                    ...
                    <div class="form-row">
                      <label for="cboStatus" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['mem_status'];?></label>
                      <div class="form-group col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?>    
    ...
    <script src="membership.js"></script>  </body>
</html>
