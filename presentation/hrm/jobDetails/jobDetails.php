      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_trn_job_details">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-hover table-bordered small" id="tblEmpJobDetails">
                    <thead class="">
                      <tr>
                        <th>Action</th>
                        <th style="width: 25%;"><?php echo $model->attributeLabels()['ejd_designation_id'];?></th>
                        <th style="width: 15%;"><?php echo $model->attributeLabels()['ejd_working_hours'];?></th>
                        <th style="width: 40%;"><?php echo $model->attributeLabels()['ejd_job_description'];?></th>
                        <th style="width: 12%;"><?php echo $model->attributeLabels()['ejd_status'];?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr class="cloneRow" style="display: none;">
                        <td align='center' class="p-1">
                          <a href="./jobDetails.php?id=" class="action" target="_parent"><span class="fas fa-pencil-alt actionView"></span></a>
                        </td>
                        <td class="designation p-1"></td>
                        <td class="hours p-1"></td>
                        <td class="description p-1"></td>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                      <div class=" form-group col-sm-4">
                        <label for="cboEmployeeId" class="col-form-label-sm"><?php echo $model->attributeLabels()['ejd_employee_id'];?></label>
                      ...
                      <div class=" form-group col-sm-4">
                        <label for="cboDesignationId" class="col-form-label-sm"><?php echo $model->attributeLabels()['ejd_designation_id'];?></label>
                      ...
                      <div class=" form-group col-sm-4">
                        <label for="txtWorkingHours" class="col-form-label-sm"><?php echo $model->attributeLabels()['ejd_working_hours'];?></label>
                        <input type="text" class="form-control form-control-sm" id="txtWorkingHours" name="txtWorkingHours" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtJobDescription" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['ejd_job_description'];?></label>
                      <div class="form-group col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtJobDescription" name="txtJobDescription" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtRemarks" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['ejd_remarks'];?></label>
                      <div class="form-group col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?>    
    ...
    <script src="jobDetails.js"></script>  </body>
</html>
