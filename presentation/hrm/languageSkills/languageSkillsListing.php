...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./languageSkillsListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_trn_language_skillsListing">
              <div class="card">
                <div class="card-header">
                   Language Skills Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridhrm_trn_language_skills" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th>Employee No</th>
                                <th>Calling Name</th>
                                <th><?php echo $model->attributeLabels()['lgs_language_id'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_skill_type_id'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_merit_id'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_status'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['lgs_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="languageSkillsListing.js"></script>    
  </body>
</html>
