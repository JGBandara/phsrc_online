...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_trn_extra_curricular_activitiesToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_trn_extra_curricular_activities tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_trn_extra_curricular_activities').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./extraCurricularActivitiesListing-db-get.php",
  ...
  $('#gridhrm_trn_extra_curricular_activities').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_trn_extra_curricular_activitiesListing #btnClose").click(function(){  
