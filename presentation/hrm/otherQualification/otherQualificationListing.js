...
$( document ).ready( function () {
  ...
  $buttons = [{text: 'Show/Hide',
      action: function ( e, dt, node, conf ) {
                    $('#hrm_trn_other_qualificationToggleModal').modal();
                },
...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridhrm_trn_other_qualification tfoot th').each( function ($k) {
      if($k>=2){
        var title = $(this).text();
  ...
  // ---------------------------------
  var table = $('#gridhrm_trn_other_qualification').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./otherQualificationListing-db-get.php",
  ...
  $('#gridhrm_trn_other_qualification').on('draw.dt', function () {
  ...
  //      Close Function
  // ---------------------------------
  $("#frmhrm_trn_other_qualificationListing #btnClose").click(function(){  
