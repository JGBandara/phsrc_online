  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-auto">
                    <div class="text-lg text-left font-weight-bold text-heder-text mb-1">Part Time Medical Specialist Practices</div>
                  </div>
                  <div class="col-auto">
                  <center><img class="rounded-circle border-red border-2" style="border:5px solid black;width:100px;height:100px" src="../../img/core/part_time_medi_specialist.jpg" alt="" /></center>
        ...
        <!-- /.container-fluid -->
<iframe src="../../Document/Part_time_Medical_Specialists.pdf" frameborder="0" height="350px" width="100%"></iframe>
      </div>
      <!-- End of Main Content -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy;<?php echo date('Y') ?>: Private Health Services Regulatory Council-Ministry of Health. All Rights Reserved</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<button class="open-button" onclick="openForm()">For More Details</button>
 ...
 <div class="form-popup" id="myForm">
  <form action="" class="form-container">
      ...
      <label><center> <img src="../../img/callman.jpg"/></center> </label>
      <label><b>Mr. Shasheendra Sanjaya</b></label><br/>
