...
<?php if($menu[2020] || true || $menu[2021]){ ?><li class="nav-item">
  ...
  <div id="collapseRenewalRegistration" class="collapse" aria-labelledby="headingRenewalRegistration" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <?php if($menu[2021] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/pmsp/renewal/basicInformation/basicInformation.php">Renewal</a>
      <?php } ?> 
      </div>
  </div>
</li>
<?php } ?><!-- Nav Item - Pages Collapse Menu -->
<?php if($menu[3200] || true || $menu[3201]){ ?><li class="nav-item">
  ...
  <div id="collapseHistory" class="collapse" aria-labelledby="headingHistory" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <?php if($menu[3201] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/pmsp/history/index.php">History</a>
      <?php } ?> 
      </div>
  </div>
</li>
