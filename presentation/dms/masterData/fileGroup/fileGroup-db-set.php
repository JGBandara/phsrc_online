...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Fi");
    ...
    $sql="insert into `dms_file_group`
            (dfg_name, dfg_remarks, dfg_status, dfg_company_id, dfg_created_by, dfg_created_on)
              values 
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `dms_file_group`
          set
            dfg_name='$name',
            dfg_remarks='$remarks',
            dfg_status='$status',
            dfg_company_id='$companyId',
            dfg_last_modified_by='$lastModifiedBy',
            dfg_last_modified_on='". time()."'
          where dfg_id='$id' and dfg_company_id='$userCompanyId'";
