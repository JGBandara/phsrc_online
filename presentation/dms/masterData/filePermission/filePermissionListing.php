...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./filePermissionListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmdms_file_permissionListing">
              <div class="card">
                <div class="card-header">
                  FilePermission Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="griddms_file_permission" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['dfp_file_category_id'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_user_id'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_status'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['dfp_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="filePermissionListing.js"></script>    
  </body>
</html>
