...
$response = [];
$autoNoType = "fileAccessLog";   
  
$requestType 	= $_REQUEST['requestType'];
$anStatus       = $_REQUEST['anStatus'];
$id             = $_REQUEST['cboSearch'];
//--------------------------------------------
$fileId           = isset($_REQUEST['cboFileId'])?trim($_REQUEST['cboFileId']):null;
$userId           = isset($_REQUEST['cboUserId'])?trim($_REQUEST['cboUserId']):null;
$accessTime           = isset($_REQUEST['dtpAccessTime'])?trim($_REQUEST['dtpAccessTime']):null;
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Fi");
    ...
    $sql="insert into `dms_trn_file_access_log`
            (dfa_file_id, dfa_user_id, dfa_access_time, dfa_remarks, dfa_status, dfa_company_id, dfa_created_by, dfa_created_on)
              values 
                ('$fileId', '$userId', '$accessTime', '$remarks', '$status', '$companyId', '$createdBy', '". time()."')";
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `dms_trn_file_access_log`
          set
            dfa_file_id='$fileId',
            dfa_user_id='$userId',
            dfa_access_time='$accessTime',
            dfa_remarks='$remarks',
            dfa_status='$status',
            dfa_company_id='$companyId',
            dfa_last_modified_by='$lastModifiedBy',
            dfa_last_modified_on='". time()."'
          where dfa_id='$id' and dfa_company_id='$userCompanyId'";
