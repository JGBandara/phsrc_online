                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                          <!-- <div class="form-group col-sm-4">
                            <label for="lblOfficeAddr" class="col-form-label-sm">Total no: of beds</label>
                            <input type="number" class="form-control form-control-sm" id="txtNoBed" name="txtNoBed" placeholder="" value='0'>
                          </div> -->
                          <div class="form-group col-sm-4">
                            <label for="txtAddress" class="col-form-label-sm">Total No. of rooms</label>
                            <input type="number" class="form-control form-control-sm" id="txtNoRoom" name="txtNoRoom" placeholder="" value='0'>
                          </div>
                          <div class="form-group col-sm-4">
                            <label for="txtAddress" class="col-form-label-sm">Total No. of Wards</label>
                            <input type="text" class="form-control form-control-sm" id="txtNoWard" name="txtNoWard" placeholder="" value='0'>
                          </div>
                        </div>                 
