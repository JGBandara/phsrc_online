  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-auto">
                    <div class="text-lg text-left font-weight-bold text-heder-text mb-1">Full Time Privet General Practice/ Dispensaries/Medical clinic</div>
                  </div>
                  <div class="col-auto">
                  <center><img class="rounded-circle border-red border-2" style="border:5px solid black;width:100px;height:100px" src="../../img/core/clinic.png" alt="" /></center>
        ...
        <!-- /.container-fluid -->
<iframe src="../../Document/Full_time_General_Practitioners_Registration_form.pdf" frameborder="0" height="350px" width="100%"></iframe>
      </div>
      <!-- End of Main Content -->
