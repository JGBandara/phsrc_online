...
<?php if($menu[2220] || true || $menu[2221]){ ?><li class="nav-item">
  ...
  <div id="collapseRenewalRegistration" class="collapse" aria-labelledby="headingRenewalRegistration" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <?php if($menu[2221] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/pml/renewal/basicInformation/basicInformation.php">Renewal</a>
      <?php } ?> 
      </div>
  </div>
</li>
...
<?php if($menu[2500] || true || $menu[2501]){ ?><li class="nav-item">
  ...
  <div id="collapseHistory" class="collapse" aria-labelledby="headingHistory" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <?php if($menu[2501] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/pml/history/index.php">History</a>
      <?php } ?> 
      </div>
  </div>
</li>
