        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmhrm_employee_files">
              ...
              <div class="card">
                <div class="card-body">
                  <?php include '../instituteTabsInstitute.php';?>                  
...
//                          $modelCategory->dfc_file_group_id =12;
...
where dms_file_category.dfc_file_group_id =12 and dfc_status = 1 and dfc_is_deleted = 0
";
                           $result=$db->singleQuery($sql);
						while($row=mysqli_fetch_array($result))
						{
							echo "<option value=\"".$row['dfc_id']."\">".$row['dfc_name']." </option>";
						}
