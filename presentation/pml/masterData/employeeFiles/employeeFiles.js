...
function loadSearchCombo($id){
	var url = "employeeFiles-db-get.php?requestType=loadSearchCombo";
...
function loadDocList($id){
    var url = "employeeFiles-db-get.php?requestType=loadDocList&id="+$id;
	var httpobj = $.ajax({url:url,async:false})
	$('#frmhrm_employee_files #cboCategoryId').html(httpobj.responseText);
}
