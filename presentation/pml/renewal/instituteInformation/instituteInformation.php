                  ...
                  <?php include '../instituteTabs.php';?>                  
                   <div id="divInstitute">
                    <div class="form-row">
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-6">
                            <label for="cboLabFacility" class="col-form-label-sm">Dental laboratory facilities</label>
                            <select class="form-control form-control-sm" id="cboLabFacility" name="cboLabFacility" placeholder="">
                         <option>&nbsp;</option>
                         ...
                         <option value="N">No</option>
                          ...
                          <div class="form-group col-sm-6">
                            <label for="txtXray" class="col-form-label-sm">X-ray facilities(The number of licence issued by the Atomic Energy Authority)</label>
                        ...
                        <div class="form-row">
                          ...
                          <option>&nbsp;</option>
                          <option value="1">Dental Surgeon</option>
