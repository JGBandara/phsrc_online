...
if ($requestType == 'loadDetails') {
  ...
  where is_renew=0 
   /* and institute_payment_detail.paymet_is_success=1 */
  /*  and institute_registration.ins_type_id=1 */
    and institute_registration.ins_created_by=$userId 
  order by ins_application_id asc";
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $response['paymentStatus'][] = $row['paymet_is_success'];
