        ...
        var httpobj = $.ajax({
            ...
            success: function (json) {
                ...
                for ($i = 0; $id.length > $i; $i++) {
                    ...
                    let statusButton = ($payStatus[$i] == 1)
                        ? "<button type='button' class='btn btn-outline-success btn-md'>Success</button>"
                        : "<button type='button' class='btn btn-outline-danger btn-md'>Fail</button>";
                    ...
                    if ($approveStatus[$i] == 1) {
                        ...
                        $('#table-id').append("<tr>" +
                            ...
                            "<td>Approved</td>" +
                            "<td><center>" +
                            "<button type='button' class='btn btn-success btn-md' data-toggle='modal'  data-target='#myModal' id='" + $id[$i] + "' >View</button>" +
                            "</center></td>" +
                            "</tr>");
