      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_location">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtAddress" class="col-sm-2 col-form-label-sm">Address</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtAddress" name="txtAddress" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtStreet" class="col-sm-2 col-form-label-sm">Street</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtStreet" name="txtStreet" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtCity" class="col-sm-2 col-form-label-sm">City</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtCity" name="txtCity" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtPhoneNo" class="col-sm-2 col-form-label-sm">Phone No</label>
                      <div class="col-sm-10">
                        <input type="tel" class="form-control form-control-sm" id="txtPhoneNo" name="txtPhoneNo" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtFaxNo" class="col-sm-2 col-form-label-sm">Fax No</label>
                      <div class="col-sm-10">
                        <input type="tel" class="form-control form-control-sm" id="txtFaxNo" name="txtFaxNo" placeholder="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="email" class="form-control form-control-sm" id="txtEmail" name="txtEmail" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtAttendanceFormat" class="col-sm-2 col-form-label-sm">Attendance Format</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtAttendanceFormat" name="txtAttendanceFormat" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtZipCode" class="col-sm-2 col-form-label-sm">Zip Code</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtZipCode" name="txtZipCode" placeholder="">
                      </div>
                    </div>
