                ...
                <tr>
                  ...
                  <td style="padding: 0px <?php echo $paddingRight;?> 0px <?php echo $paddingLeft;?>; border-bottom: 2px solid #888;">
                    <div style="float: left;">
                      <strong style="font-size: 2em;">Location</strong>
                    </div>
                  </td>
                                  </tr>
                <tr>
...
<?php
// Get details
$model->syl_company_id = $userCompanyId;
$model->syl_id = $searchId;
$model = $model->findModel();
?>
 
                          <tr>
                            <th>Code</th>
                            <td><?php echo $model->syl_code;?></td>
                          </tr>
     
                          <tr>
                            <th>Name</th>
                            <td><?php echo $model->syl_name;?></td>
                          </tr>
     
                          <tr>
                            <th>Address</th>
                            <td><?php echo $model->syl_address;?></td>
                          </tr>
     
                          <tr>
                            <th>Street</th>
                            <td><?php echo $model->syl_street;?></td>
                          </tr>
     
                          <tr>
                            <th>City</th>
                            <td><?php echo $model->syl_city;?></td>
                          </tr>
     
                          <tr>
                            <th>Phone No</th>
                            <td><?php echo $model->syl_phone_no;?></td>
                          </tr>
     
                          <tr>
                            <th>Fax No</th>
                            <td><?php echo $model->syl_fax_no;?></td>
                          </tr>
     
                          <tr>
                            <th>Email</th>
                            <td><?php echo $model->syl_email;?></td>
                          </tr>
     
                          <tr>
                            <th>Attendance Format</th>
                            <td><?php echo $model->syl_attendance_format;?></td>
                          </tr>
     
                          <tr>
                            <th>Zip Code</th>
                            <td><?php echo $model->syl_zip_code;?></td>
                          </tr>
     
                          <tr>
                            <th>Remarks</th>
                            <td><?php echo $model->syl_remarks;?></td>
                          </tr>
