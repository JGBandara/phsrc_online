...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./locationListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_locationListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_location" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="locationListing.js"></script>    
  </body>
</html>
