...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridsys_location tfoot th').each( function ($k) {
      if($k!=0){
        var title = $(this).text();
  ...
  // Create Table
  // ---------------------------------
  var table = $('#gridsys_location').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./locationListing-db-get.php",
  ...
  //      Close Function
  // ---------------------------------
  $("#frmsys_locationListing #btnClose").click(function(){  
