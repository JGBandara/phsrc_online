      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_permissionListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_permission" class="display cell-border" style="width:100%">
                        <thead>
                            <tr>
                                <th>Menu Id</th>
                                <th>User Id</th>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="permissionListing.js"></script>    
  </body>
</html>
