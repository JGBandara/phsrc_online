...
$model = new cls_sys_communication_language($db);
?><!DOCTYPE html>
<html>
  <head>
          ...
          <div class="container-fluid" id="tblReportPrint">
            ...
            <div class="row border-dark border-bottom border-2 mb-2" style="padding: 0px <?php echo $paddingRight;?> 0px <?php echo $paddingLeft;?>;">
              <div class="col-sm-12">
                      ...
                      <strong style="font-size: 2em;"> Communication Language</strong>
                </div>
            </div>
 
<?php
// Get details
$model->syg_company_id = $userCompanyId;
$model->syg_id = $searchId;
$model = $model->findModel();
?>
 
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_name'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->syg_name;?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_remarks'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->syg_remarks;?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_status'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getStatus();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_is_deleted'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getIsDeleted();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_company_id'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getCompany();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_created_by'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getCreatedBy();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_created_on'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getCreatedOn();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_last_modified_by'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getLastModifiedBy();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_last_modified_on'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getLastModifiedOn();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_deleted_by'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getDeletedBy();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['syg_deleted_on'];?></div>
