...
$response = [];
$autoNoType = "communicationLanguage";   
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Co");
    ...
    $sql="insert into `sys_communication_language`
            (syg_name, syg_remarks, syg_status, syg_company_id, syg_created_by, syg_created_on)
              values 
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `sys_communication_language`
          set
            syg_name='$name',
            syg_remarks='$remarks',
            syg_status='$status',
            syg_company_id='$companyId',
            syg_last_modified_by='$lastModifiedBy',
            syg_last_modified_on='". time()."'
          where syg_id='$id' and syg_company_id='$userCompanyId' ";
