...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./communicationLanguageListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_communication_languageListing">
              <div class="card">
                <div class="card-header">
                   Communication Language Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_communication_language" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['syg_name'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_status'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['syg_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="communicationLanguageListing.js"></script>    
  </body>
</html>
