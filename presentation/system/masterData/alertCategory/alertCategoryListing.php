...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./alertCategoryListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_alert_categoryListing">
              <div class="card">
                <div class="card-header">
                  Alert Category Listing
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_alert_category" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['sac_name'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_css_color'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_css_bg_color'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_status'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sac_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="alertCategoryListing.js"></script>    
  </body>
</html>
