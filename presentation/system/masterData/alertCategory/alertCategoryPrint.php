          ...
          <div class="container-fluid" id="tblReportPrint">
            ...
            <div class="row border-dark border-bottom border-2 mb-2" style="padding: 0px <?php echo $paddingRight;?> 0px <?php echo $paddingLeft;?>;">
              <div class="col-sm-12">
                      ...
                      <strong style="font-size: 2em;">AlertCategory</strong>
                </div>
            </div>
...
$model->sac_id = $searchId;
$model = $model->findModel();
?>
 
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_name'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->sac_name;?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_css_color'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->sac_css_color;?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_css_bg_color'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->sac_css_bg_color;?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_remarks'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->sac_remarks;?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_status'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getStatus();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_is_deleted'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getIsDeleted();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_company_id'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getCompany();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_created_by'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getCreatedBy();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_created_on'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getCreatedOn();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_last_modified_by'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getLastModifiedBy();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_last_modified_on'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getLastModifiedOn();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_deleted_by'];?></div>
              <div class="col-sm-9 p-2"><?php echo $model->getDeletedBy();?></div>
            </div>
     
            <div class="row">
              <div class="col-sm-3 p-2 bg-dark text-white border-white border-bottom"><?php echo $model->attributeLabels()['sac_deleted_on'];?></div>
