      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_alert_category">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sac_name'];?></label>
                    ...
                    <div class="form-row">
                      <label for="txtCssColor" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sac_css_color'];?></label>
                      <div class="form-group col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtCssColor" name="txtCssColor" placeholder="" data-toggle="tooltip" data-placement="top" title="Font Color">
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtCssBgColor" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sac_css_bg_color'];?></label>
                      <div class="form-group col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtCssBgColor" name="txtCssBgColor" placeholder="" data-toggle="tooltip" data-placement="top" title="Background Color">
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtRemarks" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sac_remarks'];?></label>
                      <div class="form-group col-sm-10">
                    ...
                    <div class="form-row">
                      <label for="cboStatus" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sac_status'];?></label>
                      <div class="form-group col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?> 
    ...
    <script src="alertCategory.js"></script>  </body>
</html>
