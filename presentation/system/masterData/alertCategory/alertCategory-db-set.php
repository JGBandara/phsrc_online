...
$cssBgColor           = isset($_REQUEST['txtCssBgColor'])?trim($_REQUEST['txtCssBgColor']):null;
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Al");
    ...
    $sql="insert into `sys_alert_category`
            (sac_name, sac_css_color, sac_css_bg_color, sac_remarks, sac_status, sac_company_id, sac_created_by, sac_created_on)
              values 
                ('$name', '$cssColor', '$cssBgColor', '$remarks', '$status', '$companyId', '$createdBy', '". time()."')";
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `sys_alert_category`
          set
            sac_name='$name',
            sac_css_color='$cssColor',
            sac_css_bg_color='$cssBgColor',
            sac_remarks='$remarks',
            sac_status='$status',
            sac_company_id='$companyId',
            sac_last_modified_by='$lastModifiedBy',
            sac_last_modified_on='". time()."'
          where sac_id='$id' and sac_company_id='$userCompanyId'";
