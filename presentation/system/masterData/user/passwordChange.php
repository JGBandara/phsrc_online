            ...
            <form class="needs-validation" novalidate id="frmsys_reset_users">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtCurrentPassword" class="col-sm-2 col-form-label-sm">Current Password</label>
                      <div class="col-sm-10">
                        <input type="password" class="form-control form-control-sm" id="txtCurrentPassword" name="txtCurrentPassword" placeholder="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="txtConfirmPassword" class="col-sm-2 col-form-label-sm">Retype New Password</label>
                      <div class="col-sm-10">
                        <input type="password" class="form-control form-control-sm" id="txtConfirmPassword" name="txtConfirmPassword" placeholder="">
                      </div>
                    </div>
