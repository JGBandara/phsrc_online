...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridsys_users tfoot th').each( function ($k) {
      if($k!=0){
        var title = $(this).text();
  ...
  // Create Table
  // ---------------------------------
  var table = $('#gridsys_users').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./userListing-db-get.php",
  ...
  //      Close Function
  // ---------------------------------
  $("#frmsys_usersListing #btnClose").click(function(){  
