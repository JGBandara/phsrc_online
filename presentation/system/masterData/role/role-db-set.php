...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Ro");
    }
    ...
    $sql="insert into `sys_roles`
            (syr_name, syr_remarks, syr_status, syr_company_id, syr_created_by, syr_created_on)
              values 
  ...
  try{
    ...
    $sql="update `sys_roles`
          set
            ...
            syr_remarks='$remarks',
            syr_status='$status',
            syr_company_id='$companyId',
            syr_last_modified_by='$lastModifiedBy',
            syr_last_modified_on='". time()."'
          where syr_id='$id' and syr_company_id='$userCompanyId'";
