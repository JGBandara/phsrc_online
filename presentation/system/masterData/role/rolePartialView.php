...
?><div class="modal-content">
  <div class="modal-header">
    <h5 class="modal-title" id="partialViewModalTitle">Role</h5>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group row mb-0">
          ...
          <label class="col-sm-10 col-form-label-sm data"><?php echo $model->syr_name;?></label>
        </div>
     
        <div class="form-group row mb-0">
          <label class="col-sm-2 col-form-label-sm label">Remarks</label>
          <label class="col-sm-10 col-form-label-sm data"><?php echo $model->syr_remarks;?></label>
        </div>
