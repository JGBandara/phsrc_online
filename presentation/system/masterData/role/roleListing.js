...
//                },    
  ...
  // Setup - add a text input to each footer cell
    $('#gridsys_roles tfoot th').each( function ($k) {
      if($k!=0){
        var title = $(this).text();
  ...
  // Create Table
  // ---------------------------------
  var table = $('#gridsys_roles').DataTable({
    processing: true,
    serverSide: true,
    ajax: "./roleListing-db-get.php",
  ...
  //      Close Function
  // ---------------------------------
  $("#frmsys_rolesListing #btnClose").click(function(){  
