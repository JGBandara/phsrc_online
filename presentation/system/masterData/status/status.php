      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_status">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtCssClass" class="col-sm-2 col-form-label-sm">Css Class</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtCssClass" name="txtCssClass" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtCssColor" class="col-sm-2 col-form-label-sm">Css Color</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtCssColor" name="txtCssColor" placeholder="">
                      </div>
                    </div>

                    <div class="form-group row">
                      <div class="col-sm-2 col-form-label-sm">Active</div>
                      <div class="col-sm-10">
                        <div class="form-check form-control-sm">
                          <input class="form-check-input" type="checkbox" id="optStatus" name="optStatus" value="1">
                          <!-- <label class="form-check-label" for="optStatus">Status</label>-->
                        </div>
                      </div>
                    </div>
                  </div>
