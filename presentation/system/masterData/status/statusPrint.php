                ...
                <tr>
                  ...
                  <td style="padding: 0px <?php echo $paddingRight;?> 0px <?php echo $paddingLeft;?>; border-bottom: 2px solid #888;">
                    <div style="float: left;">
                      <strong style="font-size: 2em;">Status</strong>
                    </div>
                  </td>
                                  </tr>
                <tr>
...
$model->stat_id = $searchId;
$model = $model->findModel();
?>
 
                          <tr>
                            <th>Name</th>
                            <td><?php echo $model->stat_name;?></td>
                          </tr>
     
                          <tr>
                            <th>Css Class</th>
                            <td><?php echo $model->stat_css_class;?></td>
                          </tr>
     
                          <tr>
                            <th>Css Color</th>
                            <td><?php echo $model->stat_css_color;?></td>
                          </tr>
     
                          <tr>
                            <th>Status</th>
                            <td><?php echo $model->stat_status;?></td>
                          </tr>
