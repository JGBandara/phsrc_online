...
$modelCategory = new cls_sys_alert_category($db);
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_alert_type">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_name'];?></label>
                    ...
                    <div class="form-row">
                      <label for="cboCategoryId" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_category_id'];?></label>
                      <div class="form-group col-sm-10">
                        <select class="form-control form-control-sm" id="cboCategoryId" name="cboCategoryId" placeholder="">
                          <?php 
                          $modelCategory->sac_status = 1;
                          $modelCategory->sac_is_deleted = 0;
                          $modelCategory->sac_company_id = $userCompanyId;
                    ...
                    <div class="form-row">
                      <label for="txtViewUrl" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_view_url'];?></label>
                      <div class="form-group col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtViewUrl" name="txtViewUrl" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtDetailUrl" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_detail_url'];?></label>
                      <div class="form-group col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtDetailUrl" name="txtDetailUrl" placeholder="">
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtDetailQuery" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_detail_query'];?></label>
                      <div class="form-group col-sm-10">
                        <textarea class="form-control form-control-sm" id="txtDetailQuery" name="txtDetailQuery" placeholder="" rows="3"></textarea>
                      </div>
                    </div>
      
                    <div class="form-row">
                      <label for="txtRemarks" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_remarks'];?></label>
                      <div class="form-group col-sm-10">
                    ...
                    <div class="form-row">
                      <label for="cboStatus" class="col-sm-2 col-form-label-sm"><?php echo $model->attributeLabels()['sat_status'];?></label>
                      <div class="form-group col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?>    
    ...
    <script src="alertType.js"></script>  </body>
</html>
