...
$categoryId           = isset($_REQUEST['cboCategoryId'])?trim($_REQUEST['cboCategoryId']):null;
$viewUrl           = isset($_REQUEST['txtViewUrl'])?trim($_REQUEST['txtViewUrl']):null;
$detailUrl           = isset($_REQUEST['txtDetailUrl'])?trim($_REQUEST['txtDetailUrl']):null;
$detailQuery           = isset($_REQUEST['txtDetailQuery'])?trim($_REQUEST['txtDetailQuery']):null;
...
//      $noReference	= $clsAutoNo->encodeNo($autoNo,"Al");
    }
    elseif($amStatus == "Manual"){
      $noReference	= $no;
    }
        //Add data to transaction header*******************************************
    $sql="insert into `sys_alert_type`
            (sat_name, sat_category_id, sat_view_url, sat_detail_url, sat_detail_query, sat_remarks, sat_status, sat_company_id, sat_created_by, sat_created_on)
              values 
                ('$name', '$categoryId', '$viewUrl', '$detailUrl', '$detailQuery', '$remarks', '$status', '$companyId', '$createdBy', '". time()."')";
...
elseif($requestType=='edit'){
  try{
    ...
    $sql="update `sys_alert_type`
          set
            sat_name='$name',
            sat_category_id='$categoryId',
            sat_view_url='$viewUrl',
            sat_detail_url='$detailUrl',
            sat_detail_query='$detailQuery',
            sat_remarks='$remarks',
            sat_status='$status',
            sat_company_id='$companyId',
            sat_last_modified_by='$lastModifiedBy',
            sat_last_modified_on='". time()."'
          where sat_id='$id' and sat_company_id='$userCompanyId'";
