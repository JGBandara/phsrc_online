...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./alertTypeListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_alert_typeListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_alert_type" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['sat_name'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_category_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_view_url'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_detail_url'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_detail_query'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_status'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sat_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="alertTypeListing.js"></script>    
  </body>
</html>
