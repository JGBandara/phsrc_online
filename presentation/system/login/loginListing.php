...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./loginListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_trn_loginListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_trn_login" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th><?php echo $model->attributeLabels()['tlg_user_id'];?></th>
                                <th><?php echo $model->attributeLabels()['tlg_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['tlg_location_id'];?></th>
                                <th><?php echo $model->attributeLabels()['tlg_ip_address'];?></th>
                                <th><?php echo $model->attributeLabels()['tlg_login_datetime'];?></th>
                                <th><?php echo $model->attributeLabels()['tlg_login_out_datetime'];?></th>
                                <th><?php echo $model->attributeLabels()['tlg_remarks'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="loginListing.js"></script>    
  </body>
</html>
