...
<html>
  ...
  <body id="page-top">
    ...
    <?php include "{$backwardSeparator}messageModal.php";?>
        <!-- Message Modal -->
    <?php include "./alertListingToggle.php";?>
        <!-- Partial View Modal -->
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_trn_alertListing">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <table id="gridsys_trn_alert" class="display cell-border customGrid" style="width:100%">
                        <thead>
                            <tr>
                              <th style="max-width: 20px;">Action</th>
                                <th>Read Status</th>
                                <th><?php echo $model->attributeLabels()['sal_title'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_type_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_category_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_reference_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_remarks'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_status'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_is_deleted'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_company_id'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_created_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_created_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_last_modified_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_last_modified_on'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_deleted_by'];?></th>
                                <th><?php echo $model->attributeLabels()['sal_deleted_on'];?></th>
                              </tr>
                        </thead>
                        <tfoot>
                            <tr>
...
<?php include "{$backwardSeparator}footerListing.php";?> 
    ...
    <script src="alertListing.js"></script>    
  </body>
</html>
