              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-auto">
                    <div class="text-lg text-left font-weight-bold text-primary mb-1">System Administration</div>
                  </div>
                  <div class="col-auto">
                    <!--<img src="img/core/main_item_common.jpg" alt=""/>-->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Private Health Services Regulatory Council-Ministry of Health. All Rights Reserved</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
