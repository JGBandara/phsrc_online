...
$userdiseasesId = $_SESSION['diseasesId'];
...
use presentation\system\masterData\classes\cls_sys_diseases;
$modelStatus = new cls_sys_status($db);
//$model = new cls_sys_diseases($db);
?><!DOCTYPE html>
<html>
  <head>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_diseases">
              <div class="card">
