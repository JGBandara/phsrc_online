...
$userradiologyId = $_SESSION['radiologyId'];
...
use presentation\system\masterData\classes\cls_sys_radiology;
$modelStatus = new cls_sys_status($db);
//$model = new cls_sys_radiology($db);
?><!DOCTYPE html>
<html>
  <head>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_radiology">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm">Test Type</label>
                      <div class="col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?> 
    ...
    <script src="radiology.js"></script>    
  </body>
</html>
