...
$userbirth_typeId = $_SESSION['birth_typeId'];
...
use presentation\system\masterData\classes\cls_sys_birth_type;
$modelStatus = new cls_sys_status($db);
?><!DOCTYPE html>
<html>
  <head>
    <title>Birth Type</title>
    <meta charset="utf-8">
            ...
            <form class="needs-validation" novalidate id="frmsys_birth_type">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm">Birth Type Name</label>
                      <div class="col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?> 
    ...
    <script src="birthType.js"></script>    
  </body>
</html>
