...
use presentation\system\masterData\classes\cls_sys_blood_units;
$modelStatus = new cls_sys_status($db);
//$model = new cls_sys_blood_units($db);
?><!DOCTYPE html>
<html>
  <head>
    <title>Blood Transfusion Units</title>
    <meta charset="utf-8">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_blood_units">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm">Unit Type</label>
                      <div class="col-sm-10">
...
<?php include "{$backwardSeparator}footer.php";?> 
    ...
    <script src="blood_units.js"></script>    
  </body>
</html>
