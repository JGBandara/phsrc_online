...
$userconsultationId = $_SESSION['consultationId'];
...
use presentation\system\masterData\classes\cls_sys_consultation;
$modelStatus = new cls_sys_status($db);
//$model = new cls_sys_consultation($db);
?><!DOCTYPE html>
<html>
  <head>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_consultation">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtCode" name="txtCode" placeholder="" required>
                      </div>
                    </div>
      
                    <div class="form-group row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm">Consultant Type</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtName" name="txtName" placeholder="" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm">No of Consultant</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtNo" name="txtNo" placeholder="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="txtDescription" class="col-sm-2 col-form-label-sm">Description</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtDescription" name="txtDescription">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control form-control-sm" id="cboStatus" name="cboStatus">
                          <?php 
...
<?php include "{$backwardSeparator}footer.php";?> 
    ...
    <script src="channelConsultation.js"></script>    
  </body>
</html>
