...
if($requestType=='add'){
  ...
  $sql="insert into `vc_mst_vaccines`
            (vc_code, vc_name, vc_description, vc_status, vc_company_id, vc_created_by, vc_created_on)
              values 
...
elseif($requestType=='edit'){
  ...
  $sql="update `vc_mst_vaccines`
          set
            vc_code='$code',
            vc_name='$name',
            vc_description='$description',
            vc_status='$status',
            vc_company_id='$companyId',
            vc_last_modified_by='$lastModifiedBy',
            vc_last_modified_on= now()
          where vc_id='$id' and vc_company_id='$userCompanyId'";
