...
use presentation\system\masterData\classes\cls_sys_plannning_method;
$modelStatus = new cls_sys_status($db);
//$model = new cls_sys_plannning_method($db);
?><!DOCTYPE html>
<html>
  <head>
    <title>Family plannning Method</title>
    <meta charset="utf-8">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form class="needs-validation" novalidate id="frmsys_plannning_method">
              <div class="card">
                <div class="card-header">
                Family plannning Method
                </div>
                <div class="card-body">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="txtName" class="col-sm-2 col-form-label-sm">Method Name</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="txtDescription" name="txtDescription" placeholder="">
                      </div>
                    </div>
...
<?php include "{$backwardSeparator}footer.php";?> 
    ...
    <script src="familyPlanning.js"></script>    
  </body>
</html>
