  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <a href="#" class="btn " style="background-color:#099;color:#FFF" id='butPaymentInfo'>Payments </a>
        ...
        <input type="hidden" id="txtId" name="txtId"/>
          <div class="form-row"><div class="form-group col-md-3">Name of the person who is operating or maintaining the institution</div><div class="form-group col-md-9"><label id="lblName"></label></div></div>
        
        <div class="form-row"><div class="form-group col-md-3">The relationship with the institution </div><div class="form-group col-md-3"><label id="lblRelationship"></label></div><div class="form-group col-md-3">Address</div><div class="form-group col-md-3"><label id="lblAddress"></label></div></div>
        
        <div class="form-row"><div class="form-group col-md-3">Name of the institution</div><div class="form-group col-md-3"><label id="lblInsName"></label></div><div class="form-group col-md-3">
Institute Address </div><div class="form-group col-md-3"><label id="lblInsAddress"></label></div></div>

<div class="form-row"><div class="form-group col-md-3">Province</div><div class="form-group col-md-3"><label id="lblProvince"></label></div><div class="form-group col-md-3">
District </div><div class="form-group col-md-3"><label id="lblDistrict"></label></div></div>
        </div>
<!-- ------------------------------------------------------------------------------------------------------------------------------------- -->      <div id="staffInfo">
          <div class="form-row"><div class="form-group col-md-12">Details of the Dental Surgeons and other staff attached to the institution as at the date of application</div></div>
        
        <div class="form-row"><div class="form-group col-md-12"><table width="100%" ><tr><td bgcolor="#99FFFF">Name of the Dental Surgeon/ Others</td><td bgcolor="#99FFFF">Private</td><td bgcolor="#99FFFF">Work place</td><td bgcolor="#99FFFF">Private practice (I)</td><td bgcolor="#99FFFF">Private practice (II)</td></tr></table></div></div>
        
        <div class="form-row"><div class="form-group col-md-12">Communication</div></div>
        
        <div class="form-row"><div class="form-group col-md-12"><table width="100%" ><tr><td bgcolor="#99FFFF">Name of the Dental Surgeon/ Others</td><td bgcolor="#99FFFF">General Tel. No:</td><td bgcolor="#99FFFF">Fax No:</td><td bgcolor="#99FFFF">Mobile No:</td><td bgcolor="#99FFFF">E-mail No:</td></tr></table></div></div>
        
        <div class="form-row"><div class="form-group col-md-3">SLMC Registration No</div><div class="form-group col-md-3">&nbsp;</div></div>

       
        
        <div class="form-row"><div class="form-group col-md-12">Qualifications</div></div>
        
        <div class="form-row"><div class="form-group col-md-12"><table width="100%" ><tr><td bgcolor="#99FFFF">Name of the Dental Surgeon/ Others</td><td bgcolor="#99FFFF">Qualifications</td><td bgcolor="#99FFFF">Basic</td><td bgcolor="#99FFFF">Post Graduation</td><td bgcolor="#99FFFF">Year</td><td bgcolor="#99FFFF">University</td><td bgcolor="#99FFFF">Country</td></tr></table></div></div>
        
        <div class="form-row"><div class="form-group col-md-3">Government officer or not (If yes name of the institution and the post held by the officer currently)</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
Government officer or not (If yes name of the institution and the post held by the officer currently) </div><div class="form-group col-md-3">&nbsp;</div></div>
        
        
        <div class="form-row"><div class="form-group col-md-3">Hours of practice</div><div class="form-group col-md-3">&nbsp;</div></div>
        
        </div>
  <!-- ------------------------------------------------------------------------------------------------------------------------------------- -->      
        <div id="instituteInfo">
          <div class="form-row"><div class="form-group col-md-3">Method of record keeping</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
 Availability of visiting specialists </div><div class="form-group col-md-3">&nbsp;</div></div>
        
        <div class="form-row"><div class="form-group col-md-3">Dental laboratory facilities</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
X-ray facilities(The number of licence issued by the Atomic Energy Authority) </div><div class="form-group col-md-3">&nbsp;</div></div>
        
        <div class="form-row"><div class="form-group col-md-3">Emergency kit available or not</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
Any other facilities (specify): </div><div class="form-group col-md-3">&nbsp;</div></div>

<div class="form-row"><div class="form-group col-md-3">Ownership:</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
&nbsp; </div><div class="form-group col-md-3">&nbsp;</div></div>

<div class="form-row"><div class="form-group col-md-3">Practicing as a,</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
If so, what is your speciality? </div><div class="form-group col-md-3">&nbsp;</div></div>

<div class="form-row"><div class="form-group col-md-3">Clinical waste disposal method</div><div class="form-group col-md-3">&nbsp;</div><div class="form-group col-md-3">
Method of sterilization of instruments & dressings</div><div class="form-group col-md-3">&nbsp;</div></div>
</div>
<!-- ------------------------------------------------------------------------------------------------------------------------------------- -->      <div id="facilityInfo">
