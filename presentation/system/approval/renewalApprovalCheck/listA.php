...
<!-- ------------------------------------------------------------------------------------------------------------------------------------- -->      <div id="staffInfo">
          <div class="form-row"><div class="form-group col-md-12 textMainTxtStyle">Details of the Dental Surgeons and other staff attached to the institution as at the date of application</div></div>
        ...
        <div class="form-row"><div class="form-group col-md-12 textMainTxtStyle">Communication</div></div>
        ...
        <div class="form-row"><div class="form-group col-md-3 textMainTxtStyle">SLMC Registration No</div><div class="form-group col-md-3">:&nbsp;<label class="textStyle" id="textSLMC"></label></div></div>

       
        
        <div class="form-row"><div class="form-group col-md-12 textMainTxtStyle">Qualifications</div></div>
...
<!-- <div class="form-row"><div class="form-group col-md-4">&nbsp;</div><div class="form-group col-md-4"><img src="" class="avatar1-pic" alt="Bank Slip" height="20px"></div><div class="form-group col-md-4">&nbsp;</div></div>-->
  ...
  <!-- ------------------------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div><center><textarea style="width:90%" placeholder="Please enter the reason ..." name="txtRemark" id="txtRemark"></textarea></center></div>
