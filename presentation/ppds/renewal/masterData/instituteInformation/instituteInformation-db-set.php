...
$checkpvtHsp		=($_REQUEST['checkpvtHsp']?1:0);
$checkDentalPractitioner		=($_REQUEST['checkDentalPractitioner']?1:0);
    ...
    if($row = mysqli_fetch_row($result)){
      ...
      $sql="update `institute_information`
            set
					...
					ins_is_fulltime						='$checkFullTime',
					ins_is_group				   	    ='$checkGroup',
					ins_is_individual 	                ='$checkIndividual',
					ins_is_pvt_hs_ns_home				='$checkpvtHsp',
					ins_is_pvt_dental					='$checkDentalPractitioner',
	  ...
	  ( ins_info_institute_id,ins_date_of_stablishment,ins_br_no,ins_boi_registration,ins_is_fulltime,ins_is_group,ins_is_individual,ins_is_pvt_hs_ns_home,ins_is_pvt_dental,ins_other,ins_is_com_base,ins_is_manual,ins_own_other,ins_practice_hr, ins_info_company_id,ins_info_created_by, ins_info_created_on)
              values              ('$id','$txtEstDate','$txtBR','$txtBOI','$checkFullTime','$checkGroup','$checkIndividual','$checkpvtHsp','$checkDentalPractitioner','$txtInsOther','$checkRecSystem','$checkRecKeeping','$txtOwnOther','$txtHrPractice' ,'$companyId', '$createdBy', '". time()."')";
    }
