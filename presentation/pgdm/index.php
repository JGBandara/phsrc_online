  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-auto">
                    <div class="text-lg text-left font-weight-bold text-heder-text mb-1">Part Time Private General Practice/Dispensaries/Medical clinics</div>
                  </div>
                  <div class="col-auto">
                  <center><img class="rounded-circle border-red border-2" style="border:5px solid black;width:100px;height:100px" src="../../img/core/part_time_pvet_gen.jpg" alt="" /></center>
        ...
        <!-- /.container-fluid -->
<iframe src="../../Document/Part_time_General_Practitioners_Registration_form.pdf" frameborder="0" height="350px" width="100%"></iframe>
...
<button class="open-button" onclick="openForm()">For More Details</button>
 ...
 <div class="form-popup" id="myForm">
  <form action="" class="form-container">
      ...
      <label><b>Mrs. Piyumi Amarasena</b></label><br/>
