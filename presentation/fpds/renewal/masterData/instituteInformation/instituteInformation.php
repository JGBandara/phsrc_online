...
<html>
  ...
  <body id="page-top">
    ...
    <tr><td>Full time</td><td><input type="checkbox" class="form-control form-control-sm" id="checkFullTime" name="checkFullTime"></td></tr>
    ...
    <tr><td>Private Hospital/ Nursing Home</td><td><input type="checkbox" class="form-control form-control-sm" id="checkpvtHsp" name="checkpvtHsp"></td></tr>
    <tr><td>Private Dental Practitioner:</td><td><input type="checkbox" class="form-control form-control-sm" id="checkDentalPractitioner" name="checkDentalPractitioner"></td></tr>
