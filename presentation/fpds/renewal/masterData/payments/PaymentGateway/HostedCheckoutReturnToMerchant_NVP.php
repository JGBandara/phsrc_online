...
include "connection.php"; 
  ...
  //Ensure this is the first invokation of this page
	...
	$order_reference = $new_api_lib->getRandomString(10);  
	$interaction_operator = "PURCHASE";
   	...
   	//Form the array to obtain the checkout session ID.									 
		$request_assoc_array = array("apiOperation"=>"CREATE_CHECKOUT_SESSION",
															 ...
															 "interaction.operation"=>$interaction_operator
														 		);
...
<html>
    ...
    <link href="../../css/sb-admin-2.css" rel="stylesheet"/>
       <script src="https://bankofceylon.gateway.mastercard.com/checkout/version/60/checkout.js"
               	 data-error="errorCallback"
               	 data-cancel="cancelCallback"
                 data-complete="Receipt_NVP.php"
                >
       </script>
       ...
       <script type="text/javascript">
            ...
            function cancelCallback() {
                  alert('Payment cancelled');
						...
						reference				 : <?php echo json_encode($order_reference); ?>,
        				item			 : {
        					brand: 'Mastercard',
    					...
    					interaction: {
        				merchant: {
            		name: 'PHSRC Online Registration System3',
            			address: {
            				line1: '300 Adelaide Street',
            				line2: 'Brisbane Queensland 4000'
        					},
        					  logo:  'http://phsrc.lk/images/phsrc_logo.png'
							  },
							   displayControl: {
    ...
    <body oncontextmenu="return false">
    		...
    		<p style="text-align:center;"><a href="../index.html"><img src="../../img/core/Capture.JPG" alt="Main Order Home Page" /></a></p>

        <br><br><!--<br><br>-->
       <!-- <h1 align="center"> Hosted Checkout - Return To Merchant - PHP/JavaScript/NVP</h1>-->
        <h2 align="center"> <u>Payment Confirm</u></h2>
        <p style="text-align:center;"> <strong> Order Amount : Rs <?php if (isset($order_amount)) echo $order_amount ?></p>
        ...
        <br>
         <div class="form-group row">
                    <div class="col-sm-12 text-center">
              		   ...
              		   <button type="button" class="btn btn-success" id="btnSave" onClick="Checkout.showPaymentPage();" style="width: 100px; margin: 5px;"><i class="far fa-save"></i>&nbsp;Confirm</button>
                   	   <button type="button" class="btn btn-danger" id="btnDelete" style="width: 100px; margin: 5px;"><i class="fas fa-trash-alt"></i>&nbsp;Close</button>
