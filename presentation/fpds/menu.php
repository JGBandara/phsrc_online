...
<?php if($menu[1220] || true || $menu[1221] || $menu[1222]){ ?><li class="nav-item">
  ...
  <div id="collapseRenewalRegistration" class="collapse" aria-labelledby="headingRenewalRegistration" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <?php if($menu[1221] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/fpds/renewal/basicInformation/basicInformation.php">Renewal</a>
      <?php } ?> 
            
      <?php if($menu[1222] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/fpds/renewal/masterData/basicInformation/basicInformation.php">Basic Inforrmation</a>
      <?php } ?> 
      </div>
  </div>
</li>
<?php } ?><!-- Nav Item - Pages Collapse Menu -->
<?php if($menu[1250] || true){ ?><li class="nav-item">
...
<?php } ?><!-- Nav Item - Pages Collapse Menu -->
<?php if($menu[2900] || true || $menu[2901]){ ?><li class="nav-item">
  ...
  <div id="collapseHistory" class="collapse" aria-labelledby="headingHistory" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <?php if($menu[2901] || true){ ?>      <a class="collapse-item" href="<?php echo $mainPath;?>presentation/fpds/history/index.php">History</a>
      <?php } ?> 
      </div>
  </div>
</li>
